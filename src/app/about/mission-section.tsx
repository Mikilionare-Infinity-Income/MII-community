            ...
            <div className="container px-4 md:px-6 w-full">
                <div className="mx-auto w-full flex flex-col justify-center items-center">
                    ...
                    <div className="prose text-[#0B1D26]/90">
                        ...
                        <p>
                            We combine local market expertise with global investment best practices to deliver sustainable returns while contributing to Zimbabwe's economic transformation.
                        </p>
                    </div>
                </div>
            </div>
